...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2022C/ParkingSingleMuon0/MINIAOD/PromptReco-v1/000/356/488/00000/c0d07d9d-fa5c-4de2-bf95-5415d485ae0f.root')
)
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('Parkingsinglemu.root')
)
